...
export const TECHNICAL_MEASURES = [
  <Trans
    key="0"
    id="① User's personal information is protected by password, and important data is protected by separate security function by encrypting file and transmission data or using file lock function (Lock)."
  />,

  <Trans
    key="1"
    id="② The company uses security systems such as intrusion prevention system and vulnerability analysis system for each server in preparation for external intrusion such as hacking."
  />,
];

export const ADMINISTRATIVE_MEASURES = [
  <Trans
    key="0"
    id="① Those who perform marketing work directly against the user"
  />,
  <Trans
    key="0"
    id="② Person who performs personal information management duties such as person in charge of personal information manager and employees"
  />,

  <Trans
    key="0"
    id="③ Any other person who is obliged to handle personal information in business"
  />,
  <Trans
    key="0"
    id="④ Regular in-house training and outsourcing training is conducted for employees who handle personal information, such as acquiring new security technologies and obligation to protect personal information."
  />,

  <Trans
    key="0"
    id="⑤ When join the company, internal procedures are prepared to prevent leakage of information by people through security pledge form and to monitor the performance of privacy policy and compliance with employees."
  />,
];
